IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.CA_PaquetesHomologacionPrecio') AND Type = 'U')
  DROP TABLE dbo.CA_PaquetesHomologacionPrecio
GO
CREATE TABLE [dbo].[CA_PaquetesHomologacionPrecio] (
