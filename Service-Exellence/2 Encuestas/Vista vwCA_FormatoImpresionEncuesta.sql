IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.vwCA_FormatoImpresionEncuesta') AND Type = 'V')
  DROP VIEW dbo.vwCA_FormatoImpresionEncuesta
GO
CREATE VIEW [dbo].[vwCA_FormatoImpresionEncuesta] AS 
