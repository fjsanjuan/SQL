IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.vwCA_EncuestaFacturas') AND Type = 'V')
  DROP VIEW dbo.vwCA_EncuestaFacturas
GO
CREATE VIEW [dbo].[vwCA_EncuestaFacturas] AS 
