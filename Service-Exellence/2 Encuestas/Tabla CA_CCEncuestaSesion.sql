IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.CA_CCEncuestaSesion') AND Type = 'U')
  DROP TABLE dbo.CA_CCEncuestaSesion
GO
CREATE TABLE [dbo].[CA_CCEncuestaSesion] (
