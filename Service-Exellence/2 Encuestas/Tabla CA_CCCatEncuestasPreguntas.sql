IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.CA_CCCatEncuestasPreguntas') AND Type = 'U')
  DROP TABLE dbo.CA_CCCatEncuestasPreguntas
GO
CREATE TABLE [dbo].[CA_CCCatEncuestasPreguntas] (
